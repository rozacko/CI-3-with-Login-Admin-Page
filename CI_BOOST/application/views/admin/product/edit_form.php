			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/C_product/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">

						<form action="<?= site_url('admin/C_product/update') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input name="old_image" value="<?php echo $product->image ?>" hidden />
								<div class="invalid-feedback">
